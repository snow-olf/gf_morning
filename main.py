...
def get_weather():
  ...
  return weather['weather'], math.floor(weather['low']), math.floor(weather['high']), math.floor(weather['temp']), weather['humidity'], weather['wind'], weather['airQuality'], math.floor(weather_t['low']), math.floor(weather_t['high'])
