...
def get_weather():
  ...
  return weather_t0['type'], weather_t0['low'], weather_t0['high'], weather['wendu'], weather['shidu'], weather_t0['fx']+weather_t0['fl'], weather['quality'], weather_t1['low'], weather_t1['high']
