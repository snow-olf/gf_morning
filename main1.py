...
def get_weather():
  ...
  return weather_t0['type'], math.floor(weather_t0['low']), math.floor(weather_t0['high']), math.floor(weather['wendu']), weather['shidu'], weather_t0['fl'], weather['quality'], math.floor(weather_t1['low']), math.floor(weather_t1['high'])
